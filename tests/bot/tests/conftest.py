...
def write_commands():
    return '/start - Начать знакомство.\n' \
           ...
           '/help_with_training - Загрузить рентгеновский снимок с известным результатом для моего улучшения ' \
           "('Normal', 'Doubtful', 'Mild', 'Moderate', 'Severe').\n" \
           '/cancel - Отменить некоторые действия или завершить определенные ожидания (будет описываться дальше).'

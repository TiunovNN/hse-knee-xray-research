...
from typing import TYPE_CHECKING, Any, AsyncGenerator, Deque, Dict, Optional, Type # noqa
...
class MockedSession(BaseSession):
    ...
    def add_result(self, response: Response[TelegramType]) -> Response[TelegramType]: # noqa
